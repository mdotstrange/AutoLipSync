...
namespace Slate.ActionClips
{
    ...
    public class SpeechBlendClip : ActionClip, ISubClipContainable
    {
        [SerializeField]
        [HideInInspector]
        ...
        void Do()
        {
            if (source != null)
            {
                ...
                if (SpeechBlend != null)
                {
                    SpeechBlend.ResetSpeechBlend();
                    SpeechBlend.InitSpeechBlend();
                    SpeechBlend.voiceAudioSource = source;
                }
        ...
        protected override void OnUpdate(float time, float previousTime)
        {
            if (source != null)
            {
                ...
                if (SpeechBlend != null)
                {
                    SpeechBlend.DoFixedUpdate();
                    SpeechBlend.DoLateUpdate();
                }
